...
public class virtru_java_sample {
    ...
    public void doNanoOidc() {
        try {
            ...
            TDFStorageType fileStorageType = new TDFStorageType();
            fileStorageType.setTDFStorageFileType(td.plaintextFile.getAbsolutePath());
            client.encryptFile(fileStorageType, td.encryptedFile.getAbsolutePath());

            TDFStorageType outFileStorageType = new TDFStorageType();
            outFileStorageType.setTDFStorageFileType(td.encryptedFile.getAbsolutePath());
            client.decryptFile(outFileStorageType, td.decryptedFile.getAbsolutePath());

            TDFStorageType strStorageType = new TDFStorageType();
            strStorageType.setTDFStorageBufferType(td.plaintextData);
            td.encryptedData = client.encryptData(strStorageType);

            TDFStorageType outStrStorageType = new TDFStorageType();
            outStrStorageType.setTDFStorageBufferType(td.encryptedData);

            td.decryptedData = client.decryptData(outStrStorageType);
